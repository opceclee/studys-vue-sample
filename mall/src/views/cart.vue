			...
			<div class="cart-box">
							...
							<div class="cart-group">
								...
								<div class="cart-top-items" v-for="item,index in carPanelData">
									<div class="cart-items">
										...
										<div class="operation">
											<a class="items-delete-btn" @click="delCarPanelHeadl(item.sku_id)"></a>
										</div>
				...
				<div class="cart-bottom-bg fix-bottom" v-if="count>0">
					...
					<div class="shipping">
						...
						<span class="jianguo-blue-main-btn big-main-btn js-checkout " :class="{'disabled-btn':checkCount <= 0}"><router-link to="/checkout">现在结算</router-link></span>
					</div>
				</div>
			</div>
		</div>
